---
domain: langfuse.com
path: /docs/tracing-features/log-levels
url: https://langfuse.com/docs/tracing-features/log-levels
---
...
[Question? Give us feedback → (opens in a new tab)](https://github.com/langfuse/langfuse-docs/issues/new?title=Feedback%20for%20%E2%80%9CLog%20Levels%E2%80%9D&labels=feedback)
[Edit this page on GitHub](https://github.com/langfuse/langfuse-docs/tree/main/pages/docs/tracing-features/log-levels.mdx)
Scroll to top
...
Traces can have a lot of observations ([data model](/docs/tracing#introduction-to-traces-in-langfuse)
). You can differentiate the importance of observations with the `level` attribute to control the verbosity of your traces and highlight errors and warnings. Available `levels`: `DEBUG`, `DEFAULT`, `WARNING`, `ERROR`.

In addition to the level, you can also include a `statusMessage` to provide additional context.

![Trace log level and statusMessage](https://langfuse.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftrace-log-level.a1ace0d2.png&w=3840&q=75)

PythonJS/TSOpenAI SDKLangchainLlamaIndex
...
[Trace URL](/docs/tracing-features/url "Trace URL")
[Sampling](/docs/tracing-features/sampling "Sampling")
...
Chat [Email](/cdn-cgi/l/email-protection#11626461617e6365517d707f76776462743f727e7c)
