---
domain: langfuse.com
path: /docs/fine-tuning
url: https://langfuse.com/docs/fine-tuning
---
...
*   [Export generations](#export-generations)
...
[Question? Give us feedback → (opens in a new tab)](https://github.com/langfuse/langfuse-docs/issues/new?title=Feedback%20for%20%E2%80%9CFine-tuning%E2%80%9D&labels=feedback)
[Edit this page on GitHub](https://github.com/langfuse/langfuse-docs/tree/main/pages/docs/fine-tuning.mdx)
Scroll to top
...
Langfuse is [open-source](/docs/open-source)
 and data tracked with Langfuse is open. You can easily [trace](/docs/tracing)
 your application, collect user feedback, and then use the data to fine-tune a model for your specific use case.
...
All data collected in Langfuse is also available programmatically via the API and SDKs (Python, JS/TS). Refer to the [API reference (opens in a new tab)](https://api.reference.langfuse.com/)
 and [tracing docs (_query traces_)](/docs/query-traces)
...
If you're having trouble exporting data, please [let us know](/docs/fine-tuning#contact)
