---
domain: langfuse.com
path: /docs/tracing/tags
url: https://langfuse.com/docs/tracing/tags
---
...
[Question? Give us feedback → (opens in a new tab)](https://github.com/langfuse/langfuse-docs/issues/new?title=Feedback%20for%20%E2%80%9CTagging%20traces%E2%80%9D&labels=feedback)
[Edit this page on GitHub](https://github.com/langfuse/langfuse-docs/tree/main/pages/docs/tracing-features/tags.mdx)
Scroll to top
...
Tags allow you to categorize and filter traces. You can tag traces only from the [Langfuse SDKs](/docs/sdk)
 or from the Langfuse UI. To tag a trace, add a list of tags to the tags field of the trace object. Tags are strings and a trace may have multiple tags.

PythonJS/TSOpenAILangchain (Python)Langchain (JS/TS)LlamaIndex
...
Tags enable you to flexibly add metadata to your traces. You can filter for tags in the Langfuse UI and [GET API (opens in a new tab)](https://api.reference.langfuse.com/)
.
...
[Metadata](/docs/tracing-features/metadata "Metadata")
...
Chat [Email](/cdn-cgi/l/email-protection#71020401011e0305311d101f16170402145f121e1c)
