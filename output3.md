---
domain: langfuse.com
path: /docs/experimentation
url: https://langfuse.com/docs/experimentation
---
...
*   [Automatically on popular platforms](#automatically-on-popular-platforms)
    
*   [Versions](#versions)
    

[Question? Give us feedback → (opens in a new tab)](https://github.com/langfuse/langfuse-docs/issues/new?title=Feedback%20for%20%E2%80%9CExperimentation%20(releases%20%26%20versions)%E2%80%9D&labels=feedback)
[Edit this page on GitHub](https://github.com/langfuse/langfuse-docs/tree/main/pages/docs/experimentation.mdx)
Scroll to top
...
Supported platforms include: Vercel, Heroku, Netlify. See the full list of support environment variables for [JS/TS (opens in a new tab)](https://github.com/langfuse/langfuse-js/blob/main/langfuse-core/src/release-env.ts)
 and [Python (opens in a new tab)](https://github.com/langfuse/langfuse-python/blob/main/langfuse/environment.py#L3)
.
...
![Version on single generation](https://langfuse.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fversion.7246bc98.jpg&w=3840&q=75)
...
Chat [Email](/cdn-cgi/l/email-protection#d9aaaca9a9b6abad99b5b8b7bebfacaabcf7bab6b4)
