---
domain: langfuse.com
path: /docs/integrations/langchain/example-javascript
url: https://langfuse.com/docs/integrations/langchain/example-javascript
---
...
*   [Explore the trace in Langfuse](#explore-the-trace-in-langfuse)
    

[Question? Give us feedback → (opens in a new tab)](https://github.com/langfuse/langfuse-docs/issues/new?title=Feedback%20for%20%E2%80%9CCookbook%3A%20Langchain%20Integration%20(JS%2FTS)%E2%80%9D&labels=feedback)
[Edit this page on GitHub](https://github.com/langfuse/langfuse-docs/tree/main/pages/docs/integrations/langchain/example-javascript.md)
Scroll to top
...
[Open on GitHub](https://github.com/langfuse/langfuse-docs/blob/main/cookbook/js_integration_langchain.ipynb)
[Run on Google Colab](https://colab.research.google.com/github/langfuse/langfuse-docs/blob/main/cookbook/js_integration_langchain.ipynb)
...
Follow the [integration guide (opens in a new tab)](https://langfuse.com/docs/integrations/langchain)
 to add this integration to your Langchain project. The integration also supports Langchain Python.
...
For this section we will use a very simple example prompt (from Langchain JS [docs (opens in a new tab)](https://js.langchain.com/docs/expression_language/interface)
) and ChatOpenAI. Langfuse works with any model.
...
Chat [Email](/cdn-cgi/l/email-protection#82f1f7f2f2edf0f6c2eee3ece5e4f7f1e7ace1edef)
